...
RedmineApp::Application.routes.draw do
  ...
  #Below line added by admin,without it email notofications will not send
  match '/', :to => 'welcome#index', :as => 'home'
  
  #root :controller => 'wiki', :action => 'show', :id => 'wiki_page', :project_id => 'codetiburon', :as => 'home'

  root :controller => 'projects', :action => 'show', :id => 'codetiburon', :as => 'home'
