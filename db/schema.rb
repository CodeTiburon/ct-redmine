...
ActiveRecord::Schema.define(:version => 20130819013955) do
  ...
  add_index "dmsf_workflows", ["name"], :name => "index_dmsf_workflows_on_name", :unique => true
  ...
  create_table "wiki_extensions_comments", :force => true do |t|
  ...
  create_table "wiki_extensions_counts", :force => true do |t|
    t.integer "project_id"
    t.integer "page_id"
    t.date    "date"
    t.integer "count"
  ...
  create_table "wiki_extensions_menus", :force => true do |t|
    t.integer "project_id"
    t.integer "menu_no"
    t.string  "page_name"
    t.string  "title"
  ...
  create_table "wiki_extensions_settings", :force => true do |t|
    t.integer  "project_id"
    t.datetime "created_at"
    t.datetime "updated_at"
  ...
  create_table "wiki_extensions_tag_relations", :force => true do |t|
    t.integer  "tag_id"
    t.integer  "wiki_page_id"
    t.datetime "created_at"
  end

  add_index "wiki_extensions_tag_relations", ["tag_id"], :name => "index_wiki_extensions_tag_relations_on_tag_id"
  add_index "wiki_extensions_tag_relations", ["wiki_page_id"], :name => "index_wiki_extensions_tag_relations_on_wiki_page_id"

  create_table "wiki_extensions_tags", :force => true do |t|
    t.integer  "project_id"
    t.string   "name"
    t.datetime "created_at"
  end

  create_table "wiki_extensions_votes", :force => true do |t|
    t.string  "keystr"
